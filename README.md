<div align="center"> <h1 style="font-size:4em;">Manas AI</h1> <p><b style="font-size:1.6em;">Your Intelligent Mental Wellness Companion</b></p> <img src="static/manas.png" alt="Manas AI Logo" width="250" style="border-radius:15px; margin-bottom:20px;"/> <p style="font-size:1.3em;"> Talk, reflect, monitor wellbeing, and grow with an AI designed to support emotional health. </p> <br/> <p style="font-size:1.4em;"> <a href="#overview">Overview</a> • <a href="#features">Features</a> • <a href="#installation">Installation</a> • <a href="#usage">Usage</a> </p> </div>
